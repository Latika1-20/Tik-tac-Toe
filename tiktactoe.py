...
def gameboard_pc(game_board, l1, l2):
    ...
    for i in range(3):
        ...
        for j in range(3):
            ...
            button[i][j] = Button(
                game_board, bd=8, command=get_t, height=4, width=10)
            button[i][j].grid(row=m, column=n)
    game_board.mainloop()
...
def play():
    ...
    B1 = Button(menu, text="Single Player", command=wpc,
                ...
                fg="violet", width=500, font='summer', bd=5)

    B2 = Button(menu, text="Multi Player", command=wpl, activeforeground='blue',
                activebackground="yellow", bg="blue", fg="navy blue",
                width=500, font='summer', bd=5)

    B3 = Button(menu, text="Exit", command=menu.quit, activeforeground='pink',
                activebackground="yellow", bg="pink", fg="black",
                width=500, font='summer', bd=5)
    head.pack(side='top')
    B1.pack(side='top')
    B2.pack(side='top')
